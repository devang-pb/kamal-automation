#!/usr/bin/env python3
"""Upload catalog_ahumada.csv inventory to the Procwise platform."""
...
CSV_PATH = Path(os.environ.get("OUTPUT_DIR", Path(__file__).parent / "output")) / "catalog_ahumada.csv"
CSV_COLUMNS = ["ean", "sku", "name", "stock", "price", "avg_cost"]
WAREHOUSE_ID = "783a5396-a213-44ff-b457-4c2354d3bf20"
