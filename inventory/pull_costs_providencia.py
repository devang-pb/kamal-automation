#!/usr/bin/env python3
"""Pull average unit costs from BSale's stock report endpoint for Providencia office.
...
Outputs: output/costs_providencia.csv  (ean, avg_cost)
...
def fetch_all_rows(session):
    ...
    while True:
        params = {
            "groupOffices": 0,
            "officeId": PROVIDENCIA_OFFICE_ID,
