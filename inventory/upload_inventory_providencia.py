#!/usr/bin/env python3
"""Upload catalog_providencia.csv inventory to the Procwise platform."""
...
CSV_PATH = Path(os.environ.get("OUTPUT_DIR", Path(__file__).parent / "output")) / "catalog_providencia.csv"
CSV_COLUMNS = ["ean", "sku", "name", "stock", "price", "avg_cost"]
WAREHOUSE_ID = "b8c8dbcf-7b3f-45f3-a03d-6b0f43e69bcd"
...
def main() -> InventoryDiff | None:
    ...
    try:
        ...
        diff = compute_diff(old_items, items, warehouse="Providencia")
