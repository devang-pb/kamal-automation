...
Steps:
  ...
  2. pull_costs       → fetch cost/brand data via BSale stock report (Playwright login)
  3. generate_catalog → build catalog from BSale API + costs
  4. upload_inventory → push catalog to ProcWise
"""
